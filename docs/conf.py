...
sys.path.insert(0, os.path.join(__location__, "../src"))  # for jdrones
...
# for pathgen
jdrones_dir = os.path.join(__location__, "../src/jdrones")
...
def generate(out_name, code_dir):
    ...
    try:
        ...
        cmd_line = f"sphinx-apidoc --maxdepth=8 -M -T -f -o {output_dir} {code_dir}"
...
# html_last_updated_fmt = '%b %direction, %Y'
...
latex_documents = [
    ("stack", "stack.tex", "jdrones Stack Documentation",
     "Jan-Hendrik Ewers", "howto")
]
...
intersphinx_mapping = {
    ...
    "py_trees": ("https://py-trees.readthedocs.io/en/release-2.1.x/", None),
    "pyscaffold": ("https://pyscaffold.org/en/stable", None),
    "jsim": ("https://jsim.janhendrikewers.uk", None),
